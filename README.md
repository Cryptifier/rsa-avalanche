...
- Compute the difference between each independent trial with random message and ciphertext using modulus N in a random oracle model to retrieve percentage of bits matching the original message via the ciphertext using modulus N.
